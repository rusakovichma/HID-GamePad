 ...
 */
#define USB_CFG_VENDOR_NAME     'c', 'r', 'e', 'e', 'p', 'i', 'd'
 ...
 * details. 
 */
#define USB_CFG_DEVICE_NAME     'A', 'R', 'M', ' ', 'P', 'a', 'd'
 ...
 * protocol.
 */
#define USB_CFG_HID_REPORT_DESCRIPTOR_LENGTH    27  /* total length of report descriptor */
